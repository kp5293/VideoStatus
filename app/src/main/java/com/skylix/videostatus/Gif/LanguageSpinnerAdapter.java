...
public class LanguageSpinnerAdapter extends BaseAdapter {
    ...
    public LanguageSpinnerAdapter(Activity a, List<CategoryModel> listGif) {
        this.a = a;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.id_text.setText(listGif.get(position).getId().toString());
        viewHolder.name_txt.setText(listGif.get(position).getLanguage());
