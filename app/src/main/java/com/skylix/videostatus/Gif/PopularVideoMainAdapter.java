...
public class PopularVideoMainAdapter extends RecyclerView.Adapter<PopularVideoMainAdapter.MyViewHolder> {
    ...
    public PopularVideoMainAdapter(Activity activity, List<CategoryModel> listGif) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Config.KEY_INTENT_POPULAR, "Popular");
